...
class machineButtonPerform implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(max == 0){
            ...
            ThreadLocalRandom random = ThreadLocalRandom.current(); // the class to generate trandom numbers
            ...
            vectors.rowData.remove(randnum); // remove data from 2D Vector rowData
            
            max = vectors.rowData.size(); // update the current size of rowData
